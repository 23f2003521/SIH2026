...
5. **The demonstration AIS is reconstructed.** Vessel particulars, position and timing
   follow the public casualty record; the individual pings are synthesis.
6. **Synthetic radar frames prove plumbing, not accuracy.** They are out of
   distribution for the segmenter, which responds to them almost identically
   regardless of what was drawn. Real Sentinel-1 imagery is required for any claim
